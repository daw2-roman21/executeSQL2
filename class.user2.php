...
class User {
        ...
        public function Save() {
                ...
                if (isset($this->ID)) {
                        // EL USUARIO YA EXISTE POR LO TANTO ACTUALIZAMOS LOS VALORES
                        ...
                        echo "<br>QUERY DEL UPDATE: " . $strQuery;   //MUESTRO LA QUERY PARA COMPROBAR QUE ESTÁ BIEN
                        $objStatement->execute();
                } else {
                                        //ENTRAREMOS AL ELSE YA QUE EL USUARIO NO ESTARÁ CREADO
                        $strValueList = "";
                        ...
                        print("<br>QUERY DEL INSERT: " . $strQuery);                         // ECHO PARA COMPROBAR QUE LA QUERY ES CORRECTA
                        $objStatement->execute();
        ...
        public function MarkForDeletion() {
                //MARCAMOS PARA QUE EL REGISTRO SE ELIMINE
                $this->blForDeletion = true;
        }

        public function __destruct() {
                if (isset($this->ID)) {
                        //ELIMINAMOS EL REGISTRO SI ESTABA MARCADO
                        if ($this->blForDeletion == true) {
                                ...
                                print("<br>ELIMINANDO USUARIO...");     //MENSAJE PARA COMPROBAR
                                $objStatement->execute();
                        };
                }
        }
